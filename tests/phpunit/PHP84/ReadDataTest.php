...
namespace Rundiz\NestedSet\Tests\PHP84;
...
class ReadDataTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetTaxonomyWithParents()
    {
        ...
        $this->assertTrue(empty(array_diff(['Root 3', '3.2', '3.2.1', '3.2.2'], $resultNames)));
        $this->assertEquals(count($result), count($resultNames));
        unset($result, $resultNames);
    ...
    public function testGetTaxonomyWithChildren()
    {
        ...
        $this->assertTrue(empty(array_diff(['Root 3', '3.1', '3.2', '3.2.1', '3.2.2', '3.2.3', '3.3'], $resultNames)));
        $this->assertEquals(count($result), count($resultNames));
        unset($result, $resultNames);
        ...
        $resultNames = $this->getNamesAsArray($result, 't_name');
        $this->assertCount(7, $result);
        $this->assertTrue(empty(array_diff(['2.1', '2.1.1', '2.1.1.1', '2.1.1.2', '2.1.1.3', '2.1.2', '2.1.3'], $resultNames)));
        $this->assertEquals(count($result), count($resultNames));
        unset($result, $resultNames);
